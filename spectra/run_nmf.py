...
def binarize_nmf(w, sum_threshold, par=1, lower_bound=3, upper_bound=40):
    ...
    ## if there are more than 40 samples that have a value of 0.1 in the W matrix OR if very very few samples (less than 3) have a value of 0.1, 
    ## then the allocation to a cluster is determined by doing mean+par*std for a cluster
